...
/**
 * Permission load list response dto class
 * 
 * @author NoBugLady
 *
 */
public class PermissionLoadListResponseDto {

	public List<PermissionEntity> permissionList = new ArrayList<>();
	public Map<String, String> permissionDetailMap = new HashMap<>();
	public Map<String, List<CustomPermissionCategoryEntity>> permissionDetailListMap = new HashMap<>();
