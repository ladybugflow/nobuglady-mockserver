...
import io.github.nobuglady.mockserver.service.AdminRoleBusiness;
...
public class AdminRoleController {
	 ...
	 * @return permissions
	 */
	@RequestMapping(value = "/admin/request_role_load_permission", method = RequestMethod.POST)
	@ResponseBody
	public List<PermissionEntity> requestRoleLoadPermission() {

		RoleLoadPermissionRequestDto requestDto = new RoleLoadPermissionRequestDto();
		RoleLoadPermissionResponseDto responseDto = new RoleLoadPermissionResponseDto();

		adminRoleBusiness.requestPermissionList(requestDto, responseDto);
		return responseDto.permissionList;
